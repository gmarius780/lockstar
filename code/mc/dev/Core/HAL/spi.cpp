...
void SPI::writeData(uint8_t data) { SPI_regs->TXDR = data; }
...
//__attribute__((section("sram_func")))
void SPI::enable_spi_rx_dma() { SPI_regs->CFG1 |= SPI_CFG1_RXDMAEN; }

//__attribute__((section("sram_func")))
void SPI::disable_spi_rx_dma() { SPI_regs->CFG1 &= ~SPI_CFG1_RXDMAEN; }

//__attribute__((section("sram_func")))
void SPI::enable_spi_tx_dma() { SPI_regs->CFG1 |= SPI_CFG1_TXDMAEN; }
