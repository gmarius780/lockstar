...
void ScopeModule::setup_scope(RPIDataPackage *read_package) {
  ...
  bool success = scope->setup_scope(
      sampling_prescaler, sampling_counter_max, sample_in_one, sample_in_two,
...
void ScopeModule::set_scope_sampling_rate(RPIDataPackage *read_package) {
  ...
  bool success =
      scope->set_sampling_rate(sampling_prescaler, sampling_counter_max);
...
void ScopeModule::get_scope_data(RPIDataPackage *read_package) {
  ...
  bool success = scope->push_buffers_to_rpi_data_package(
      write_package, buffer_offset, package_size);
...
void ScopeModule::scope_timer_interrupt() { scope->timer_interrupt(); }
