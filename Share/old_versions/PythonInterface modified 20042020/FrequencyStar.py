...
class ControlGUI(tk.Tk):
    ...
    def scan(self):
        ...
        self.trace_data = self.root.MCU.pop_readqueue()
        ...
        # plot new data
        self.scan_plot.plot(self.trace_voltages, self.trace_transmission, self.trace_errorsignal)
    ...
    def setup_plots(self):
        ...
        tk.Spinbox(plotframe, from_=-10.0, to=10.0, increment=1, borderwidth=0, textvar=self.Config.trace_from, width=4, font=('Copperplate Gothic Bold', self.fontsize), foreground='white', background='black', buttonbackground='black').grid(row=1, column=1)
        ...
        tk.Spinbox(plotframe, from_=-10.0, to=10.0, increment=1, borderwidth=0, textvar=self.Config.trace_to, width=4, font=('Copperplate Gothic Bold', self.fontsize), foreground='white', background='black', buttonbackground='black').grid(row=2, column=1)
        ...
        tk.Spinbox(plotframe, from_=0.0, to=1.0, increment=0.01, borderwidth=0, textvar=self.Config.trace_stepsize, width=4, font=('Copperplate Gothic Bold', self.fontsize), foreground='white', background='black', buttonbackground='black').grid(row=3, column=1)
    ...
    def check_read_queue(self):
        if self.MCU.mode=='run':
            if len(self.MCU.read_queue)>0:
                ...
                # plot
                self.ax_live.plot(self.plotrange, data_transmission, c='C0')
                self.ax_live.plot(self.plotrange, data_errorsignal, c='C1')
                self.graph_live.draw()
