...
class Settings:
    ...
    def SetLinPivots(self, array, timestamp):
        ...
        self.lin_pivots.set(json.dumps(array))
    ...
    def SetLockTrace(self, piezo, transm, errors):
        self.lock_piezo.set(json.dumps(piezo.tolist()))
        self.lock_transm.set(json.dumps(transm.tolist()))
        self.lock_errors.set(json.dumps(errors.tolist()))
