...
def get_lock_points(piezo, transm, errors, offset, signal_threshold="AUTO", flank=FLANK_FALLING, smooth_window=51):
...
def get_flanks(piezo, errors, rel_threshold=0.1, flank=FLANK_FALLING, smooth_window=51):
    ...
    grad = ndi.gaussian_filter1d(grad, smooth_window/2)
